...
- Install a content/ad blocker for your browser: I recommend [uBlock Origin](https://github.com/gorhill/uBlock) (available for Firefox, Chrome and Safari on most platforms). You can also complement this with the [Electronic Frontier Foundation]'s [Privacy Badger](https://www.eff.org/privacybadger) tool that protects you from invasive ads and third-party tracking.
