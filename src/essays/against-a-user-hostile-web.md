...
- If you use Chrome as your main browser, consider switching to the open-source version called [Ungoogled-Chromium](https://github.com/Eloston/ungoogled-chromium). Better yet, switch to [Pale Moon](http://palemoon.org/), developed by ex-Mozilla Firefox users that are taking a stand against telemetry, tracking, and modern bloat. Consider minimalist browsers like [Min](https://minbrowser.github.io/min/) (and choose to block all ads, trackers and scripts) to browse news websites.
